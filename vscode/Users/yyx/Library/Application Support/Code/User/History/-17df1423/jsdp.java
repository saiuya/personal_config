...
import com.saiuya.blog.mapper.MenuMapper;
...
import com.saiuya.blog.model.vo.response.MetaResp;
import com.saiuya.blog.model.vo.PageResult;
import com.saiuya.blog.model.vo.query.OnlineUserQuery;
import com.saiuya.blog.model.vo.query.UserQuery;
import com.saiuya.blog.model.vo.request.*;
import com.saiuya.blog.model.vo.response.*;
import com.saiuya.blog.strategy.context.UploadStrategyContext;
import com.saiuya.blog.utils.SecurityUtils;
...
public class UserService extends ServiceImpl<UserMapper, User> {
    ...
    public boolean isMenuFrame(UserMenuResp menu) {
        return menu.getParentId().equals(CommonConstant.PARENT_ID)
                && CommonConstant.TYPE_MENU.equals(menu.getMenuType());
    }
    ...
    public boolean isParentView(UserMenuResp menu) {
        return !menu.getParentId().equals(CommonConstant.PARENT_ID)
                && CommonConstant.TYPE_DIR.equals(menu.getMenuType());
    }
