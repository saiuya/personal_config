...
import com.saiuya.blog.config.properties.GiteeProperties;
import com.saiuya.blog.constant.SocialLoginConstant;
import com.saiuya.blog.enums.LoginTypeEnum;
import com.saiuya.blog.exception.ServiceException;
import com.saiuya.blog.model.dto.GitUserInfoDTO;
import com.saiuya.blog.model.dto.SocialTokenDTO;
import com.saiuya.blog.model.dto.SocialUserInfoDTO;
import com.saiuya.blog.model.dto.TokenDTO;
...
public class GiteeLoginStrategyImpl extends AbstractLoginStrategyImpl {
    ...
    public SocialUserInfoDTO getSocialUserInfo(SocialTokenDTO socialToken) {
        ...
        // Gitee用户信息
        GitUserInfoDTO gitUserInfoDTO = restTemplate.getForObject(giteeProperties.getUserInfoUrl(),
                GitUserInfoDTO.class, dataMap);
        // 返回用户信息
