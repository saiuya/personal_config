...
import com.saiuya.blog.config.properties.QiniuProperties;
...
public class QiniuUploadStrategyImpl extends AbstractUploadStrategyImpl {
    ...
    public void upload(String path, String fileName, InputStream inputStream) {
        try {
            ...
            // 上传图片文件
            Response res = uploadManager.put(inputStream, path + fileName,
                    auth.uploadToken(qiniuProperties.getBucketName()), null, null);
            if (!res.isOK()) {
