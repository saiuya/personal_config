...
import com.saiuya.blog.entity.Role;
import com.saiuya.blog.entity.UserRole;
import com.saiuya.blog.mapper.RoleMapper;
import com.saiuya.blog.mapper.RoleMenuMapper;
import com.saiuya.blog.mapper.UserRoleMapper;
import com.saiuya.blog.model.vo.PageResult;
import com.saiuya.blog.model.vo.query.RoleQuery;
import com.saiuya.blog.model.vo.request.RoleReq;
import com.saiuya.blog.model.vo.request.RoleStatusReq;
import com.saiuya.blog.model.vo.response.RoleResp;
...
public class RoleService extends ServiceImpl<RoleMapper, Role> {
    ...
    public void addRole(RoleReq role) {
        ...
        // 添加新角色
        Role newRole = Role.builder().roleName(role.getRoleName()).roleDesc(role.getRoleDesc())
                .isDisable(role.getIsDisable()).build();
    ...
    public void updateRole(RoleReq role) {
        ...
        Role existRole = roleMapper.selectOne(
                new LambdaQueryWrapper<Role>().select(Role::getId).eq(Role::getRoleName, role.getRoleName()));
        ...
        Role newRole = Role.builder()
                ...
                .roleDesc(role.getRoleDesc()).isDisable(role.getIsDisable())
                .build();
