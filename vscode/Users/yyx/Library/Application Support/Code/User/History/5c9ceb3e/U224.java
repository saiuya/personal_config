...
import com.saiuya.blog.model.vo.request.TalkReq;
import com.saiuya.blog.model.vo.response.CommentCountResp;
...
import com.saiuya.blog.utils.CommonUtils;
...
import static com.saiuya.blog.constant.RedisConstant.TALK_LIKE_COUNT;
import static com.saiuya.blog.enums.ArticleStatusEnum.PUBLIC;
import static com.saiuya.blog.enums.CommentTypeEnum.TALK;
...
public class TalkService extends ServiceImpl<TalkMapper, Talk> {
    ...
    public PageResult<TalkResp> listTalkVO(PageQuery pageQuery) {
        ...
        List<Integer> talkIdList = talkRespList.stream()
                .map(TalkResp::getId)
                .collect(Collectors.toList());
        List<CommentCountResp> commentCountVOList = commentMapper.selectCommentCountByTypeId(talkIdList,
                TALK.getType());
