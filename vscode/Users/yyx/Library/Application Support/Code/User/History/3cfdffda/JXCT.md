...
イェン：日本語の特訓
　　　HDMとスマートホンそれぞれの利点欠点を整理し，それぞれに適したコンテンツを検討する．
 
  質問：questの利用を前提とした場合，現実空間の特定の位置に永続的にアンカーを置くことは可能か？　日照，天候，時間帯，植物の影響は？
　　　　HMDでユーザの視界をすべて映像に置き換えてしまうなら，無理にARにする必要はないのでは？あらかじめ撮影しておいた360画像にCGを合成したものを表示する方が簡単に思える．
