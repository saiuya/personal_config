// package com.saiuya.blog.config;
//
...
// return
// BindingBuilder.bind(emailSimpleQueue()).to(emailExchange()).with(EMAIL_SIMPLE_KEY);
// }
//
// /**
// * 绑定邮件Html队列
...
// return
// BindingBuilder.bind(emailHtmlQueue()).to(emailExchange()).with(EMAIL_HTML_KEY);
// }
//
// /**
// * 文章交换机
...
// return
// BindingBuilder.bind(articleQueue()).to(articleExchange()).with(ARTICLE_KEY);
// }
// }