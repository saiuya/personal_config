...
def main():
    # 设置DeepL Api key环境变量
    os.environ["DEEPL_API_KEY"] = "fec7aaed-77e1-4d41-8043-e0e9062624d6:fx"
    ...
    parser.add_argument(
        "--dest", type=str, default="zh", natgeshelp="Output language or the srt file"
    )
    parser.add_argument(
    ...
    parser.add_argument(
        "--suffix", type=str, default="", help="original file suffix to rename"
    )
    parser.add_argument(
        "--new_suffix", type=str, default="", help="new suffix to change to"
    )
