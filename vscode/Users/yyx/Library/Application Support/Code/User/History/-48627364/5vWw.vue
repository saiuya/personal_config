...
let originPosition: string;
let endLabelPosition: string;
function updateLabels() {
  originPosition = startLabel.value;
  endLabelPosition = endLabel.value;
}
async function calculateAndDisplayRoute(
  ...
  watch([originPosition, endLabelPosition], ([startLabelNew, endLabelNew]) => {
    directionsService
      .route({
        // origin: (document.getElementById("start") as HTMLSelectElement).value,
        // destination: (document.getElementById("end") as HTMLSelectElement).value,
        origin: startLabelNew,
        destination: endLabelNew,
        travelMode: TravelMode.DRIVING,
        transitOptions: {
          modes: [TransitMode.BUS],
        },
