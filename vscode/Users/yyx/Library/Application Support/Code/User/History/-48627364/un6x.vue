...
async function initMap() {
  ...
  (document.getElementById("start") as HTMLInputElement).addEventListener(
    "blur",
    onChangeHandler
  );
  (document.getElementById("end") as HTMLInputElement).addEventListener(
    "blur",
    onChangeHandler
  );
}
...
<template>
  ...
  <div id="floating-panel">
    <b>起点: </b>
    <input type="text" id="start" v-model="startLabel" placeholder="请输入出发地址" />
    &nbsp;
    <b>目的地: </b>
    <input type="text" id="end" v-model="endLabel" placeholder="请输入目的地" />
