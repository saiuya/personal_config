...
public interface CommentMapper extends BaseMapper<Comment> {
         ...
         * @return 说说评论量
         */
        List<CommentCountResp> selectCommentCountByTypeId(@Param("typeIdList") List<Integer> typeIdList,
         ...
         * @return 回复数量
         */
        List<ReplyCountResp> selectReplyCountByParentId(
                        @Param("parentCommentIdList") List<Integer> parentCommentIdList);
         ...
         * @return 回复评论集合
         */
        List<ReplyResp> selectReplyByParentId(@Param("limit") Long limit, @Param("size") Long size,
